...
{
    public class EmployeeRegisterCommandHandler : IRequestHandler<UserRegisterCommand, UserResponseModel>
    {
        private readonly IUserIdentityService _userIdentity;
        private readonly IMemberRepository _memberRepository;
        private readonly IEmployeeRepository _employeeRepository;

        public EmployeeRegisterCommandHandler(IUserIdentityService userIdentity,
