...
const Navbar: FC = (): ReactElement => {
  ...
  return (
      <Container maxWidth="xl">
        <Toolbar disableGutters sx={{display:'flex', flexDirection:'row', justifyContent:'space-between', py: 0, my: 0}}>
                ...
                renderValue={(value) => {
                  return (
                    <Box sx={{ display:"flex", justifyContent:'flex-end', gap: 1, py:0, my:0 }}>
                      <>
                        <Typography mx='auto' fontSize={14} my={0} py={0} display={'flex'} alignItems='center'
                        color={isDark ? theme.palette.success.dark : theme.palette.success.light} 
