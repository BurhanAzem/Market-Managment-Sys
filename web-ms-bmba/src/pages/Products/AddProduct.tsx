...
import { AppDispatch, RootState } from "../../redux_old/store/store";
...
import { getCategories } from "../../redux_old/actionCreators/categoryActions";
import AddDiscountModal from "../../modals/AddDiscountModal";
import { ActionType, IOpenAddDiscountModal } from "../../redux_old/actionTypes/discountActionTypes";
...
const AddProduct: FC = (): ReactElement => {
  ...
  const { categories, loading, error } = useAppSelector((state: { category: any }) => state.category);
  ...
  const isAddDiscountModalOpen = useAppSelector((state: { discount: any; }) => state.discount.isAddDiscountModalOpen); // Get product state
